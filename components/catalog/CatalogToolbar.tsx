...
export function CatalogToolbar({ filters, categories }: CatalogToolbarProps) {
  ...
  return (
    <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl py-6">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-full text-[13px] font-semibold text-neutral-900 hover:text-neutral-500 transition-colors"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="overflow-hidden border-t border-neutral-100 mt-6"
          >
            <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 flex flex-wrap gap-2">
                <FilterPill
                  label="Все"
