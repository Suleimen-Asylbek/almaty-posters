...
const features = [
  {
    ...
    desc: 'Используем профессиональное оборудование и бумагу премиального класса.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    title: 'Размеры 30×40 / 40×50 / 50×70',
    desc: 'Три формата для любого интерьера — от уютного декора до акцентной стены.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    desc: 'Быстрая доставка по всему городу. Сроки уточняйте в WhatsApp.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    title: 'Индивидуальные постеры',
    desc: 'Сделаем постер по вашему дизайну или идее. Обсудим всё в WhatsApp.',
  },
];
